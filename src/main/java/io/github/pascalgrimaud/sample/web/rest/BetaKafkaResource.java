...
@RestController
@RequestMapping("/api/beta-kafka")
public class BetaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BetaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private Map<String, SafeKafkaConsumer> consumers = new ConcurrentHashMap<>();

    public BetaKafkaResource(KafkaProperties kafkaProperties) {
